...
urls = [
    "https://www.factoriesinspace.com/ism-advanced-materials",
    "https://www.factoriesinspace.com/ism-biotechnology",
    "https://www.factoriesinspace.com/ism-large-structures",
    "https://www.factoriesinspace.com/ism-microfabricated-goods",
    "https://www.factoriesinspace.com/ism-novelty-goods",
    "https://www.factoriesinspace.com/ism-pure-substances",
    "https://www.factoriesinspace.com/ism-space-food",
]
...
def add_missing_product_name(tbl_: IdentObj[RawTable]) -> IdentObj[RawTable]:
    ...
    for ri in range(1, nrows):
        data[ri, new_product_idx].value = (
            str(data[ri, 4].value).strip() + " by " + str(data[ri, 0].value).strip()
        )
    return IdentObj(
